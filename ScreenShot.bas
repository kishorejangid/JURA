Attribute VB_Name = "ScreenShot"
 ...
 '       #If Win32 Then
     ...
     End Function
     Public Function CaptureGraph(frmSrc As Form) As Picture
        ' Call CaptureWindow to capture the entire form given its window
        ' handle and then return the resulting Picture object.
        Set CaptureGraph = CaptureWindow(frmSrc.hwnd, False, frmSrc.ScaleX(250, vbTwips, vbPixels), frmSrc.ScaleY(4690, vbTwips, vbPixels), frmSrc.ScaleX(10050, vbTwips, vbPixels), frmSrc.ScaleY(3230, vbTwips, vbPixels))
     End Function
